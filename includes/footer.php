    ...
    <div class="container">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="footer-widget footer-about-widget mb-4 pb-3" data-aos="fade-up" data-aos-duration="800">
                        <div class="widget-content">
                            ...
                            <p class="mb-4">Bistly Restaurant offers flavorful dishes, cozy ambiance.</p>
                        ...
                        <div class="widget-content">
                            ...
                            <form action="#" method="POST">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="submit-btn">Subscribe <i class="far fa-paper-plane"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="copyright-area">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="copyright-link text-md-end" data-aos="fade-left" data-aos-duration="1400">
